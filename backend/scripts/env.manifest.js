...
const optional = [
  ...
  'ADMISSION_TOTAL_BUDGET_MS',
  'ADMISSION_IDENTITY_RESOLUTION_MS',
  'ADMISSION_SCOPE_READ_MS',
  'ADMISSION_CAP_CHECK_MS',
  'ADMISSION_METER_RESERVE_MS',
  'ADMISSION_BUDGET_ENFORCEMENT',
  'ADMISSION_P99_WINDOW_MS',
  'ADMISSION_MIN_SAMPLES_P99',
  'ADMISSION_IDENTITY_CACHE_ENABLED',
  'ADMISSION_IDENTITY_CACHE_TTL_MS',
  'ADMISSION_IDENTITY_CACHE_MAX_ENTRIES',
  'ADMISSION_SCOPE_CACHE_ENABLED',
  'ADMISSION_SCOPE_CACHE_TTL_MS',
  'ADMISSION_SCOPE_CACHE_MAX_ENTRIES',
  'ADMISSION_CAP_CACHE_ENABLED',
  'ADMISSION_CAP_CACHE_TTL_MS',
  'ADMISSION_CAP_CACHE_MAX_ENTRIES',
  'ADMISSION_METER_CACHE_ENABLED',
  'ADMISSION_METER_CACHE_TTL_MS',
  'ADMISSION_METER_CACHE_MAX_ENTRIES',
  'ADMISSION_PARALLEL_CHECKS',
  'ADMISSION_REVOCATION_CHECK_INTERVAL_MS',
