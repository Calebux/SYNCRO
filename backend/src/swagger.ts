...
import { generateOpenApiSpecFromRegistry } from './router/openapi-generator';
import { createApiRouter } from './router/mount';
import { RateLimiterFactory } from './middleware/rate-limit-factory';

// Initialize the registry by creating the API router
createApiRouter();
...
// Generate the full spec from registry
const registrySpec = generateOpenApiSpecFromRegistry(baseDefinition as OpenAPIV3_1.Document);

const options: swaggerJSDoc.Options = {
  definition: registrySpec,
  apis: [
