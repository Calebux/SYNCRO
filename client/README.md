...
2. **Set up environment variables** - Create `.env.local`:
   ...
   # Payment (optional - for live payment testing)
...
- Create, edit, delete subscriptions with validation
- Bulk operations (archive, delete multiple)
- Category organization and tagging
- Price tracking and renewal date management
- Direct merchant cancel links
...
- Security settings (MFA, sessions, password)
- Email account connections (read-only preparation)
